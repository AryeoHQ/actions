...
class MakeActionTest extends TestCase
{
    ...
    public Action $reference {
        get => new Action(name: 'SyncRepos', baseNamespace: 'Workbench\\App\\Services');
    }

    /** @var array<string, mixed> */
    public array $baselineInput {
        get => ['name' => 'SyncRepos', 'class' => 'Workbench\\App\\Services\\Github', '--no-test' => true];
    }
    ...
    {
        $this->artisan($this->command, ['name' => 'SyncRepos', 'class' => 'Workbench\\App\\Services\\Github'])->assertSuccessful();
    ...
    public function colocated_test_can_be_suppressed(): void
    {
        ...
        $this->assertFileDoesNotExist($this->reference->test->filePath->toString());
    }
}
