...
class AsActionCannotUseDispatchableTest extends TestCase
{
    private AsActionCannotUseDispatchable $rule;
    ...
    {
        parent::setUp();
        $this->rule = app(AsActionCannotUseDispatchable::class);
    ...
    #[Test]
    public function removes_dispatchable_trait_from_as_action(): void
    {
        $code = $this->getFixture('AsActionWithDispatchable.php');
